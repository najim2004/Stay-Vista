        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="space-y-6">
            ...
            <div className="space-y-1 text-sm">
              ...
              <select
                required
                className="w-full px-4 bg-white py-3 border-rose-300 focus:outline-rose-500 rounded-md"
                name="category"
              >
          ...
          <div className="space-y-6">
            ...
            <div className=" p-4 bg-white w-full flex items-center justify-between gap-4  m-auto rounded-lg">
              ...
              {imgPreview && (
                <img
                  className="h-[70px] max-w-[150px] rounded-sm flex-1"
                  src={imgPreview}
                  alt=""
                />
              )}
            ...
            <div className="space-y-1 text-sm">
              ...
              <textarea
                id="description"
                className="block bg-white rounded-md focus:rose-300 w-full h-32 px-4 py-3 text-gray-800  border border-rose-300 focus:outline-rose-500 "
                name="description"
              ></textarea>
            </div>
          </div>
